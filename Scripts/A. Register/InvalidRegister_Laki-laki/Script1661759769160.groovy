...
WebUI.click(findTestObject('Page_RegistPeX/dropdown_Laki-laki'))
...
WebUI.verifyElementText(findTestObject('Page_RegistPeX/Verify_InvalidRegister'), 'Email, phone, or username already registered')
