...
WebUI.setText(findTestObject('Object Repository/Page_RegistPeX/input_namaLengkap'), 'Dedemesh')

WebUI.setText(findTestObject('Page_RegistPeX/input_tanggalLahir'), '10102001')
...
//if (true) {
//}
WebUI.setText(findTestObject('Object Repository/Page_RegistPeX/input_noHP'), '1234567890')

WebUI.setText(findTestObject('Object Repository/Page_RegistPeX/input_email'), 'Dede@sharklasers.com')

WebUI.setText(findTestObject('Object Repository/Page_RegistPeX/input_password'), 'Dedemesh1@')
